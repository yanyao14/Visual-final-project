...
function loadMovieTypeTimeDetail(data) {
	...
	var option = {
		...
		grid: { left: '15.5%', right: '19%', bottom: '10%' },
		xAxis: {
			type: 'category',
			//name: '年份',
			axisLine: { lineStyle: { color: '#57617B' } },
			axisLabel: { interval:10, textStyle: { color: '#fff', } },
			data: data.year
		},
		yAxis: [
			...
			{//柱状图
				...
				axisLine: { lineStyle: { color: '#57617B' } },
				axisLabel: { margin: 15, textStyle: { fontSize: 2 }, textStyle: { color: '#fff' }, formatter: '{value}' },
				splitLine: {
					show: true,
					lineStyle: {
						type: 'dashed',
